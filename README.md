...
| 회원 관리              | 로그인 / 회원정보     | 강좌(Course) 관리     | 수강 관리      | 관리자 기능              |
| ------------------ | -------------- | ----------------- | ---------- | ------------------- |
| ✓ 아이디 중복 확인        | ✓ 아이디/비밀번호 로그인 | ✓ 강좌 등록 / 수정 / 삭제 | ✓ 수강 신청    | ✓ 회원 관리 (학생/강사/관리자) |
| ✓ 비밀번호 암호화         | ✓ 비밀번호 변경      | ✓ 강좌 목록 조회        | ✓ 수강 취소    | ✓ 강좌 승인 / 관리        |
| ✓ 이름 / 이메일 입력      | ✓ 개인정보 수정      | ✓ 강좌 상세 정보        | ✓ 수강 내역 조회 | ✓ 수강 현황 통계          |
| ✓ 소셜 로그인 연동        | ✓ 로그인 유지       | ✓ 강사 배정           | ✓ 진도율 관리   | ✓ 공지사항 관리           |
| ✓ 회원 유형 선택 (학생/강사) | ✓ 로그아웃         | ✓ 강좌 상태 관리        | ✓ 수료 처리    | ✓ 시스템 설정            |
