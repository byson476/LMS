...
| 구분 | 주요 기능 |
|------|----------|
| **회원 관리** | 아이디 중복 확인<br>비밀번호 암호화<br>이름 / 이메일 입력<br>회원 유형 선택 (학생 / 강사)<br>소셜 로그인 연동 |
| **로그인 / 회원정보** | 아이디 / 비밀번호 로그인<br>비밀번호 변경<br>개인정보 수정<br>로그인 유지<br>로그아웃 |
| **강좌(Course) 관리** | 강좌 등록<br>강좌 수정<br>강좌 삭제<br>강좌 목록 조회<br>강좌 상세 정보 조회<br>강사 배정<br>강좌 상태 관리 |
| **수강 관리** | 수강 신청<br>수강 취소<br>수강 내역 조회<br>진도율 관리<br>수료 처리<br>수료증 조회 |
| **관리자 기능** | 회원 관리 (학생 / 강사 / 관리자)<br>강좌 승인 / 반려<br>강사 권한 관리<br>공지사항 관리<br>시스템 통계 관리 |
