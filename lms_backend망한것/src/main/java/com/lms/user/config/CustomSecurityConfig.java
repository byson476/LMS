  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http.authorizeHttpRequests((authorize) -> {
      authorize.requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
          ...
          //.requestMatchers(HttpMethod.GET, "/courses/courses_list").permitAll()
          //.requestMatchers("/courses/**").hasAnyRole("STUDENT","TUTOR","ADMIN")
          //.requestMatchers("/courses/**").hasAnyAuthority("ROLE_STUDENT","ROLE_TUTOR","ROLE_ADMIN")
