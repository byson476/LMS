...
@Override
@Transactional
public List<CourseEnrollmentViewDto> courseList(Student student) {

System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!courseList    :::: " );
	Student studentEntity = studentRepository.findById(student.getStudentId())
		.orElseThrow(() -> new RuntimeException("학생 없음"));

    List<CourseEnrollmentViewDto> courseEnrollmentViewDtos = courseEnrollmentRepository.findCourseEnrollmentsByStudent(studentEntity.getStudentId());
