...
public class CourseEnrollmentController {
	...
	/*public ResponseEntity<Map<String, Object>> courses_list(@PathVariable("userId") String userId,
       													@RequestParam("userRole") String userRole) throws Exception {
        System.out.println("!!!!!!!!!!!!!!!########### courses_list userId : " + userId + ", userRole : " + userRole);
		switch (userRole) {
			case "STUDENT":
		...
		List <CourseEnrollmentViewDto> data = courseEnrollmentService.courseList(student);
